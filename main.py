...
if online == True:
    status = "Succeffully"
    print(f"{Blue}            Packages Imported")
    print(f"{Green}[Installed]{White} | pip install pygame")
    print(f"{Green}[Installed]{White} | pip install pygame-menu")
    print(f"{Green}[Installed]{White} | pip install pygame-gui")
    print(f"{Green}[Installed]{White} | pip install pygame-textinput")
    print(f"{Green}[Installed]{White} | pip install pygame-widgets")
    print(f"{Green}[Installed]{White} | pip install pygame-menu-extras")
    print(f"{Green}[Installed]{White} | pip install pygame-gui-menu")
    print(f"{Green}[Installed]{White} | pip install pygame-gui-menu-extras")
...
888888ba           dP       dP                 a8888a  d88888P 
88    `8b          88       88                d8' ..8b     d8' 
88     88 .d8888b. 88  .dP  88  .dP  dP    dP 88 .P 88    d8'  
88     88 88'  `88 88888"   88888"   88    88 88 d' 88   d8'   
88     88 88.  .88 88  `8b. 88  `8b. 88.  .88 Y8'' .8P  d8'    
dP     dP `88888P' dP   `YP dP   `YP `8888P88  Y8888P  d8'     
                                          .88                  
                                      d8888P""")
